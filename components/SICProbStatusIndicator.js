const SICProbStatusIndicator = (props) => {
  return (
    <div>
      {props.isExpired ? (
        <div className="flex items-center gap-1.5 font-bold text-sm bg-red-500 p-2 rounded-lg">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className="flex items-center gap-1.5 font-bold text-sm bg-green-500 p-2 rounded-lg">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
